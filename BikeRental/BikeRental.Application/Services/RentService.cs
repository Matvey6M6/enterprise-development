...
public class RentService
{
    ...
    public RentService(IRepository<Rent, int> rentRepository)
    {
    ...
    {
        var rent = await _rentRepository.GetByKey(key);
        if (rent == null)
        ...
        await _rentRepository.Update(key, rent);
    ...
    {
        var rent = await _rentRepository.GetByKey(id);
        if (rent == null)
            return false;
    ...
    {
        var rents = await _rentRepository.GetAsList();
